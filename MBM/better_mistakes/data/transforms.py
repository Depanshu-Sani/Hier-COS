...
mean_wildlife = [0.5049453338941641, 0.47518435054543134, 0.39866407116509983]
std_wildlife = [0.2826844936328479, 0.2628417756838465, 0.2581046945884192]
...
normalize_wildlife_species = transforms.Normalize(mean=mean_wildlife, std=std_wildlife)

normalize_tfs_dict = {
    "tiered-imagenet-224": normalize_tfs_ilsvrc12,
    "inaturalist19-224": normalize_tfs_inat19,
    "fgvc-aircraft": normalize_fgvc_aircraft,
    "wildlife-species": normalize_wildlife_species,
}
