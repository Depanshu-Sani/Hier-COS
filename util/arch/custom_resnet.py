...
class ResNet50_flamingo_l3(nn.Module):
    ...
    def forward(self, x, targets):
        ...
        fpa = None
        all_out = [manu_out, family_out, variant_out]
        all_targets = [manu_targets, family_targets, targets]
        for i in range(1, 3):
            if fpa is None:
...
class ResNet50_flamingo_l7(nn.Module):
    ...
    def forward(self, x, targets):
        ...
        fpa = None
        all_out = [kingdom_out, phylum_out, class_out, order_out, family_out, genus_out, species_out]
        all_targets = [kingdom_targets, phylum_targets, class_targets, order_targets, family_targets, genus_targets, targets]
        for i in range(1, 7):
            if fpa is None:
                fpa = (all_out[i-1].argmax(1) == all_targets[i-1]) & (all_out[i].argmax(1) == all_targets[i])
            else:
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        fpa = None
        all_out = [l1_out, l2_out, l3_out, l4_out, l5_out, l6_out, l7_out, l8_out, l9_out, l10_out, l11_out, l12_out]
        all_targets = [l1_targets, l2_targets, l3_targets, l4_targets, l5_targets, l6_targets, l7_targets, l8_targets, l9_targets, l10_targets, l11_targets]
        for i in range(1, 12):
            if fpa is None:
                fpa = (all_out[i-1].argmax(1) == all_targets[i-1]) & (all_out[i].argmax(1) == all_targets[i])
            else:
...
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        fpa = None
        all_out = [l1_out, l2_out, l3_out, l4_out, l5_out, l6_out, l7_out]
        all_targets = [kingdom_targets, phylum_targets, class_targets, order_targets, family_targets, genus_targets, targets]
        for i in range(1, 7):
            if fpa is None:
                fpa = (all_out[i-1].argmax(1) == all_targets[i-1]) & (all_out[i].argmax(1) == all_targets[i])
...
class ResNet50_hafeat_l12_cejsd_wtconst_dissim(nn.Module):
    ...
    def forward(self, x, targets, is_inference):
        ...
        fpa = None
        all_out = [l1_out, l2_out, l3_out, l4_out, l5_out, l6_out, l7_out, l8_out, l9_out, l10_out, l11_out, l12_out]
        all_targets = [l1_targets, l2_targets, l3_targets, l4_targets, l5_targets, l6_targets, l7_targets, l8_targets, l9_targets, l10_targets, l11_targets, targets]
        for i in range(1, 12):
            if fpa is None:
                fpa = (all_out[i-1].argmax(1) == all_targets[i-1]) & (all_out[i].argmax(1) == all_targets[i])
            else:
